...
class HistogramWidget(object):
	...
	def showDialogBox(self, driver):
		...
		self.ui_l.lineEdit.setText(str(driver.cMin)) #sets the intensity value
		self.ui_l.lineEdit_2.setText(str(driver.cMax))#sets the opacity value 
	...
	def accept(self):
		...
		self.setColorMap(self.d.pRenderer.colorFunc, colorMap, self.d.cMin, self.d.cMax)#from where pRenderer has been taken 
...
#there are many ways to turn on the interactive plotting like ion()
