...
form matplotlib.backends.qt_compat import QtCore,QtWidgets
...
class ApplicationWindow(QWidgets.QMainWindow):

	def __init__(self):
		super().__init__ ()
		self._main = QWidgets.Qwidget()
		self.setCentralWidget(self._main)
		layout = QWidget.QVBoxLayout( self._main)
